...
from arguments.ns_hyper import get_args


def main():
    args = get_args()

    save_path = os.path.join('out', 'ns_hyper', args.name)
    ...
    config_file = os.path.join('config', 'ns_hyper.cfg')
    custom_config = [
    ...
    config_out_file = os.path.join(save_path, 'ns_hyper.cfg')
